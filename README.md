...
Kraken is under active development. The project is being rebuilt incrementally around clearer runtime, container, and per-game launch abstractions while keeping the existing launcher experience intact.

## Download
[Download Kraken](https://github.com/Yerlsd/Kraken/releases)

* Please note Kraken is currently available for macOS 14 (Sonoma) and above.
  To verify your Mac's compatibility with Sonoma, visit https://support.apple.com/en-us/105113

## Dependencies
Kraken uses the following Swift dependencies:
...
- [WhatsNewKit](https://github.com/SvenTiigi/WhatsNewKit) — A Swift Package to easily showcase new app features.
