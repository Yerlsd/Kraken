...
// FIXME: unify with EpicGamesGameImportView
struct LocalGameImportView: View {
            ...
            HStack {
                ...
                VStack {
                    Form {
                        ...
                        // FIXME: boilerplate, shared with EpicGamesGameImportView
                        HStack {
...
#Preview {
    LocalGameImportView(isPresented: .constant(true))
}
